...
namespace Poker
{
    public abstract class GamePlayer
    {
        ...
        List<StandardCard> Hand { get; set; }
        public int HandCount { get => Hand.Count; }
        public string[] HandArray { get => StandardCard.HandForConsole(Hand); }
        ...
        public virtual void ReceiveCard(StandardCard cardReceiving)
        {
        ...
        /// </summary>
        public virtual void ReceivedCardScreen(StandardCard cardReceived)
        {
            ...
            ConsoleController.PrintVerticalHorizontal(cardAndMessage, true, true);
        }
